...
%% estimation sample (until February 2020)
Tend = find(year(TimeMACRO)==2020 & month(TimeMACRO)==2);       
...
T1av = find(year(TimeMACRO)==2020 & month(TimeMACRO)==2);       % date of last available data for forecasts
